        ...
        {activeTab === 'stats' && (
          <motion.div key="stats-view" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 10 }} transition={{ duration: 0.2 }}>
            ...
            <div className="mt-[32px] px-[24px]">
              <h2 className="font-inter text-[28px] font-extrabold text-[#16161B] uppercase leading-tight">HELLO, OWNER</h2>
            ...
            <div className="mt-[24px] px-[24px]">
               ...
               <div style={{ background: 'linear-gradient(-45deg, #BDBDBD, #4F4F4F)', padding: '1px', borderRadius: '12px', boxShadow: '4px 4px 10px rgba(0, 0, 0, 0.08)' }}>
                <div className="bg-[#FFFFFF] rounded-[11px] py-[20px] px-[20px] w-full h-full flex flex-col gap-[20px]">
                  ...
                  {[1, 2].map((artistNum) => (
                    <div key={artistNum} className="flex flex-col gap-[6px] border-b border-[#16161B] pb-[16px]">
                      <span className="font-inter text-[14px] font-normal text-[#16161B]">Artist {artistNum}</span>
                      <span className="font-inter text-[14px] font-bold text-[#16161B]">Revenue Generated - 0000/-</span>
                      <span className="font-inter text-[14px] font-normal text-[#16161B]">Hours - 0h 0m</span>
                      <span className="font-inter text-[14px] font-normal text-[#16161B]">Price Category - 1</span>
                    </div>
                  ))}

                  <div className="flex flex-col gap-[6px]">
                    <span className="font-inter text-[14px] font-normal text-[#16161B]">Artist 3</span>
                    <span className="font-inter text-[14px] font-bold text-[#16161B]">Revenue Generated - 0000/-</span>
                    <span className="font-inter text-[14px] font-normal text-[#16161B]">Hours - 0h 0m</span>
                    <span className="font-inter text-[14px] font-normal text-[#16161B]">Price Category - 1</span>
                  </div>
